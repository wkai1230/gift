 ...
 */
public class HomeOtherRecyclerAdapter extends RecyclerView.Adapter<HomeOtherRecyclerAdapter.ViewHolder> {

    private List<HomeHeartExpandInfo.DataEntity.ItemsEntity> dateList;
    private Context mContext;

    public HomeOtherRecyclerAdapter( Context mContext,List<HomeHeartExpandInfo.DataEntity.ItemsEntity> dateList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.tvLike.setText(dateList.get(position).getLikes_count() + "");

        holder.textView.setText(dateList.get(position).getTitle());
        Picasso.with(mContext).load(dateList.get(position).getCover_image_url()).into(holder.imageView);
    }
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    HomeHeartExpandInfo.DataEntity.ItemsEntity itemsEntity = dateList.get(getPosition());
